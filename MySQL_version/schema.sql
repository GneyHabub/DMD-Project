...
CREATE TABLE pharmasist(
    ...
    reasearch TINYINT NOT NULL-- Analogus to Boolean. 1 - True, 0 - False
);
...
CREATE TABLE head_nurse(
    id INT UNIQUE,
    FOREIGN KEY(id) REFERENCES staff_member(id),
    surgery_assistant TINYINT NOT NULL -- Whether or not he/she sometimes assist in surgeries
);
...
CREATE TABLE nurse(
    ...
    appointment_assistant TINYINT NOT NULL, -- Whether or not he/she sometimes assist during appointments
    departement_id INT,
...
CREATE TABLE professor(
    ...
    surgery_participation TINYINT NOT NULL,
    departement_id INT,
    FOREIGN KEY (departement_id) REFERENCES departement(id)
);
...
CREATE TABLE doctor(
    ...
    emergency_hours TINYINT NOT NULL, -- Has them or not
...
CREATE TABLE food(
    ...
    amount INT,
    supplier VARCHAR(30),
    can_be_allergic TINYINT -- Boolean
);
