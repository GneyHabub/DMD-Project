...
class DB:
    def __init__(self,user = "postgres", password = "12345", host = "127.0.0.1", port = "5432", database = "DMD1"):
    ...
    def clean_schema_files(self):
        f = open('dep_lab.sql', 'w')
        f.close()
        f = open('person_member.sql', 'w')
        f.close()
        f = open('contact_details.sql', 'w')
        f.close()
        f = open('appointment.sql', 'w')
        f.close()
        f = open('complaint.sql', 'w')
        f.close()
        f = open('medicine_surgery.sql', 'w')
        f.close()
        f = open('events_other.sql', 'w')
        f.close()
        f = open('feedback.sql', 'w')
        f.close()
        f = open('schedule.sql', 'w')
        f.close()
    ...
    def _generate_facilities(self, write_schema_flag=True, write_json_flag=False):
        ...
        for i in range(self.num_departements):
            ...
            if(write_schema_flag):
                with open('dep_lab.sql', 'a+') as append_file:
    ...
    def _generate_person_member_db(self, num, write_schema_flag=True, write_json_flag=False):
        ...
        for i in range(0, num):
            ...
            if(write_schema_flag):
                with open('person_member.sql', 'a+') as append_file:
                    # person
            ...
            if(write_schema_flag):
                with open('contact_details.sql', 'a+') as append_file:
    ...
    def _generate_appointment_db(self, num=10000, write_schema_flag=True, write_json_flag=False):
        for i in range(num):
            ...
            if(write_schema_flag):
                with open('appointment.sql', 'a+') as append_file:
    ...
    def _generate_complaint_db(self, num=30, write_schema_flag=True, write_json_flag=False):
        for i in range(num):
            ...
            if(write_schema_flag):
                with open('complaint.sql', 'a+') as append_file:
    ...
    def _generate_medicine_surgery_db(self, num=40, write_schema_flag=True, write_json_flag=False):
        ...
        for i in range(min(num+60,len(self.medicine_list))):
            ...
            if(write_schema_flag):
                with open('medicine_surgery.sql', 'a+') as append_file:
    ...
    def _generate_events_other_db(self, num=30, write_schema_flag=True, write_json_flag=False):
        ...
        for i in range(num):
            ...
            if(write_schema_flag):
                with open('events_other.sql', 'a+') as append_file:
    ...
    def _generate_feedback_db(self, num=30, write_schema_flag=True, write_json_flag=False):
        for i in range(num):
            ...
            if(write_schema_flag):
                with open('feedback.sql', 'a+') as append_file:
    ...
    def _generate_schedule_db(self, num=30, write_schema_flag=True, write_json_flag=False):
        for i in range(num):
            ...
            if(write_schema_flag):
                with open('schedule.sql', 'a+') as append_file:
...
if __name__ == "__main__":
    ...
    db.generate()
    db.pg_query("dep_lab.sql")
    db.pg_query("person_member.sql")
    db.pg_query("contact_details.sql")
    db.pg_query("appointment.sql")
    db.pg_query("complaint.sql")
    db.pg_query("medicine_surgery.sql")
    db.pg_query("events_other.sql")
    db.pg_query("feedback.sql")
